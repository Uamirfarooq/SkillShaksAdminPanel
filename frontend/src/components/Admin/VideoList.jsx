...
const VideoList = () => {
  ...
  return (
    <div className="container border border-black dark:border-gray-700 mx-auto px-4 py-6 max-w-4xl">
    ...
    {Array.isArray(videos) && videos.length > 0 ? (
      videos.map((video, index) => (
        <div
          ...
          className="flex relative items-center space-x-4 max-h-40 p-4 border-b dark:border-gray-700 last:border-none hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-300"
        >
          <div className="w-36">
          ...
          <div className="border border-black dark:border-gray-700 w-full max-h-20">
            <h3 className="text-sm max-w-2xl font-semibold text-gray-800 dark:text-gray-100">{video.title}</h3>
            <p className="text-gray-600 dark:text-gray-400 max-h-8 overflow-hidden text-sm mt-1">{video.description}</p>
            <div className="flex absolute bottom-1 space-x-4 font-bold text-sm text-gray-600 dark:text-gray-400 mt-2">
