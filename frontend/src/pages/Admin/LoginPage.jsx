  ...
  return (
    <div className='bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8'>
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight">Sign in to Admin Panel of SkillShaks</h2>
      </div>
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                autoComplete="email"
                required
                className={`block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ${emailError ? 'ring-red-500' : 'ring-gray-300 dark:ring-gray-600'} focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:focus:ring-indigo-500 sm:text-sm sm:leading-6 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100`}
                value={email}
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                required
                className={`block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ${passwordError ? 'ring-red-500' : 'ring-gray-300 dark:ring-gray-600'} focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:focus:ring-indigo-500 sm:text-sm sm:leading-6 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100`}
                value={password}
