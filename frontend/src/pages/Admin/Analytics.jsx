  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Teacher vs Course Sales</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Courses Added by Month</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Students Added by Month</h2>
