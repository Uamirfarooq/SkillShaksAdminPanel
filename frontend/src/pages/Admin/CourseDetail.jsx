...
const CourseDetail = () => {
  ...
  <aside className="group/sidebar flex flex-col shrink-0 max-w-screen-sm transition-all duration-300 ease-in-out m-0 z-50 inset-y-0 left-0 bg-white dark:bg-gray-800 border-r border-r-dashed border-r-neutral-200 dark:border-r-neutral-700 sidenav fixed-start loopple-fixed-start">
